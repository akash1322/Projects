...
Description: It is a spell checker program. It checks if the spelling of the entered word is right or wrong. I spelling is wrong it gives suggestions of correct spellings.
